...
import 'package:phoenix_club/utils/horizontal_calendar/calendar_tile.dart';
  ...
  Widget get nameAndIconRow {
    ...
    if (widget.showCalendarPickerIcon) {
      rightInnerIcon = new IconButton(
        ...
        icon: new Icon(Icons.calendar_today, color: Colors.white54,),
      );
    } else {
    ...
    if (widget.showChevronsToChangeRange) {
      leftOuterIcon = new IconButton(
        ...
        icon: new Icon(Icons.chevron_left, color: Colors.white54,),
      );
      rightOuterIcon = new IconButton(
        onPressed: isExpanded ? nextMonth : nextWeek,
        icon: new Icon(Icons.chevron_right, color: Colors.white54,),
      );
    } else {
    ...
    if (widget.showTodayAction) {
      leftInnerIcon = new InkWell(
        child: new Text("Aujourd'hui", style: TextStyle(color: Colors.white54),),
        onTap: resetToToday,
      );
    } else {
    ...
    Utils.weekdays.forEach(
        ...
        dayWidgets.add(
          new CalendarTile(
            isDayOfWeek: true,
            dayOfWeek: day,
            dateStyles: TextStyle(color: Colors.white54),
          ),
        );
      },
    );
        ...
        if (this.widget.dayBuilder != null) {
          ...
          dayWidgets.add(
            new CalendarTile(
              ...
              date: day,
              dateStyles: TextStyle(color: Colors.white),// configureDateStyle(monthStarted, monthEnded),
